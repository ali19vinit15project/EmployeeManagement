...
import com.vinit.employeemanagement.exception.StorageException;
import com.vinit.employeemanagement.exception.StorageFileNotFoundException;
...
public class FileSystemStorageService implements FileService {
    ...
    @Autowired
    public FileSystemStorageService(@Value("${file-location}") String storageLocation) {
